    ...
    <div v-else>
          ...
          <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            <div class="flex flex-wrap items-center gap-2.5">
              <a
                ...
                class="inline-flex items-center gap-2 px-4 py-2.5 bg-primary hover:bg-primary-dark text-white rounded-xl text-sm font-semibold transition-all shadow-glow-red"
              >
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <a
                ...
                target="_blank"
                rel="noopener"
                class="inline-flex items-center gap-2 px-4 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-sm font-semibold transition-all"
              >
              ...
              <button
                ...
                class="inline-flex items-center gap-2 px-3.5 py-2.5 bg-white/10 hover:bg-white/20 text-white border border-white/20 rounded-xl text-sm font-semibold transition-all backdrop-blur-md"
              >
                ...
                Showroom Tour ({{ dealer.showroomImages.length }} Photos)
              </button>

              <button
                @click="openBookingModal()"
                class="inline-flex items-center gap-2 px-4 py-2.5 bg-white/15 hover:bg-white/25 text-white border border-white/20 rounded-xl text-sm font-semibold transition-all backdrop-blur-md"
              >
                <svg class="w-4 h-4 text-amber-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
                Book Test Drive / Visit
              </button>
            </div>
          </div>
        </div>
      ...
      <div class="bg-white border-b border-border sticky top-16 z-30 shadow-xs">
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
          <div class="flex items-center gap-2 sm:gap-6 overflow-x-auto py-2">
            <button
              v-for="tab in [
